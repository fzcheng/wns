	...
	<body class="main_body">
		...
		<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr> 
					...
					<form id="textform" name="textform" action="<%=request.getContextPath()%>/bacl_admin.do?comd=TotalGamepayWeek"  method="post">
					...
					<c:forEach items="${totalGamepayWeek}" var="totalp">
				...
				function Hand(){
				 ...
				 window.location.href="<%=request.getContextPath()%>/bacl_admin.do?comd=HandTotalGamepayWeek";
				}
			</script>
	</body>
</html>
