...
<html>
	...
	<body class="main_body" onmouseover="self.status='欢迎光临本站';return true">
	     <center><font color="#FF0000">${message}</font></center>
		    <div  align="left"> 
	     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;每日汇总充值金额&nbsp;&nbsp;
	      &nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="手动汇总" onclick="Hand()"></div>
	      
		<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr> 
					<td align="center" colspan="13" >
					<form id="textform" name="textform" action="<%=request.getContextPath()%>/bacl_admin.do?comd=TotalGamepayDay"  method="post">
					...
					<c:forEach items="${totalGamepayDay}" var="totalp">
					 
					  <c:if test="${channelId eq '0'}">
			...
			<script type="text/javascript">
				...
				function Hand(){
				 ...
				 window.location.href="<%=request.getContextPath()%>/bacl_admin.do?comd=HandTotalGamepayDay";
				}
			</script>
	</body>
</html>
