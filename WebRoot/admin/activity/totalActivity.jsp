...
function confirmRefresh() {
	...
	<c:if test="${message != null && message != ''}">
		...
		<table width="50%" border="0px" cellpadding="0" cellspacing="0" style="margin-left: 60">
		 ...
		 <input onclick="confirmRefresh('totalActivity')" type="button" value="刷新商品列表"/>
		 </c:if>
		...
		<table border="0px" cellpadding="0" cellspacing="0" width="50%" style="margin-left: 60">
		 ...
		 <form id="editForm" action="<%=request.getContextPath()%>/bacl_admin.do?comd=editShopTotal" method="post">
