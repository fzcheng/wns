...
<html>
	...
	<center><font color="#FF0000">${message}</font></center>
		...
		<input id="comd" name="comd" value="scoreSumList" type="hidden" />
			...
			<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr> 
					...
					<tr> 
						...
						<td align="center">消耗总积分</td> 
						<td align="center">当前积分</td> 
						<td align="center">时间</td> 
					</tr>
				<c:if test="${not empty scoreSumList}">
				<c:forEach var="rk" items="${scoreSumList}">
						<tr> 
							<td align="center">${rk.roleId}</td>
							<td align="center"><a href="#" onclick="getInfo('${rk.roleId}')">${rk.roleName}</td>
							<td align="center">${rk.insumtotal}</td>
							<td align="center">${rk.outsumtotal}</td>
							<td align="center">${rk.insumtotal+rk.outsumtotal}</td>
