...
<html>
	...
	<center><font color="#FF0000">${message}</font></center>
		...
		<input id="comd" name="comd" value="scoreByIdList" type="hidden" />
			...
			<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr> 
					...
					<tr> 
						...
						<td align="center">玩家操作</td>
						<td align="center">积分</td> 
						<td align="center">时间</td> 
					</tr>
				<c:if test="${not empty scoreList}">
				<c:forEach var="rk" items="${scoreList}">
						<tr> 
							<td align="center">${rk.roleId}</td>
							<td align="center">${rk.roleName}</td>
							<td align="center">${rk.name}</td>
							<td align="center">${rk.count}</td>
	...
	function  backScoreList(){
	 	window.location.href="bacl_admin.do?comd=scoreSumList";
