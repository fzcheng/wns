...
<html>
	...
	<center><font color="#FF0000">${message}</font></center>
		...
		<input id="comd" name="comd" value="consumerecordByIdList" type="hidden" />
		...
		<input id="totalPage" name="totalPage" value="${paging.totalPage}" type="hidden" />
			<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<c:if test="${not empty consumerecordList}">
				<c:forEach var="rk" items="${consumerecordList}">
						<tr> 
							...
							<td align="center">${rk.goodsMoney}</td>
							<td align="center">${rk.createTime}</td>
						</tr>
				</c:forEach>
				<tr>
				<td ><a href="#" onclick="backScoreList()" style="margin-left: 10;" >返回列表</a></td>
				<td align="center" colspan="12">
	...
	function  getInfo(grpId){
	 	window.location.href="bacl_admin.do?comd=scoreByIdList&roleId="+grpId;
		
	}
	
	function  backScoreList(){
	 	window.location.href="bacl_admin.do?comd=consumerecordSumList";
