		...
		<script language="JavaScript">
			function lTor(){
				...
				$("#funcList option:selected").each(function(){
					var rVal = $(this).val();
              		...
              		if($.trim(rText) != $.trim(menuText)){
              			$("#roleFuncList").append("<option value='"+rVal+"'>"+menuText+"-"+rText+"</option>");
              		}else{
              			$("#roleFuncList").append("<option value='"+rVal+"'>"+rText+"</option>");
              		}
				...
				$("#roleFuncList option:selected").each(function(){
					var lVal = $(this).val();
              		...
              		if(lText.indexOf("-") != -1){
              			...
              			if($.trim(lText) == $.trim(menuText)){
              				$("#funcList").append("<option value='"+lVal+"'>"+lText+"</option>");
                     		$(this).remove();
              			}else{
              				$(this).remove();
              			}
			...
			function getFuncList(){
				 ...
				 $.ajax({   
		              type: "POST",   
		              url: "bacl_admin.do",   
		              data: "comd=getMenuList&powerId=" + id,   
		              dataType : "xml",   
...
<tr> 
	<td align="center"><strong>分配菜单权限</strong></td>
</tr>
<tr> 
...
<tr> 
	<td align="center">
	<form id="textform" name="textform" action="<%=request.getContextPath()%>/bacl_admin.do?comd=updateRoleMenu" method="post">
