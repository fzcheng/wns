...
public class bestpaycb extends javax.servlet.http.HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		BestpayRecordVO bestpayrecord = bestpayrecordservice.getRecordBySMSID(ORDERSEQ);
		...
		logger.warn("bestpayrecord:"+bestpayrecord.toString());
		...
		bestpayrecord.setTRANDATE(TRANDATE);
