 ...
 * 12:49:38 PM
 */
public abstract class MbpayResponseEncoder {
	...
	public MbpayResponseEncoder(HttpServletRequest request, HttpServletResponse response)
	{
		result = 0;
...
//	}
	...
	public void write()
	{
		try 
		{
			...
			//String encryptStr = CryptUtil.encryptBy3DesAndBase64(jsonstr, "2h1U2oW1dXnEarGHKrnWfNFk");
			
			int residue = jsonstr.length() % 8;
			if (0 != residue)
			{
			...
			out.write(CryptUtil.encryptBy3Des(jsonstr.getBytes(), "2h1U2oW1dXnEarGHKrnWfNFk"));
			
			//out.write(utf2Bytes(encryptStr));
			out.flush();
		}
		catch (IOException e)
		{
